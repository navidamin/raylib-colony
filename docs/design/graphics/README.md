...
| `../prospecting/prototypes/layer-block.html` | the reference for the **solid body** (section 9.47): the four strata as one cut block, peeled a layer at a time, sharing the drill bar's straight depth axis |
