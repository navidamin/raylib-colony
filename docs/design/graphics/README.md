...
| `../prospecting/prototypes/layer-block.html` | the reference for the **solid body** (9.47), **fog of war** (9.48) and **drilling** (9.49): the four strata as one cut block, peeled a layer at a time, unknown until a borehole establishes it, sharing the drill bar's straight depth axis — and a lever board for its shape |
