...
| 15 | [survey-dashboard-design.md](survey-dashboard-design.md) | **THE NEW LOOK.** The module as a five-panel console on a 1536x1024 field: a machined tool rack, a live *software-3D* holographic block with yaw, pitch, explode and isolate, a scrolling survey log, the drill bar and rig telemetry, in navy and cyan instead of near-black and amber. Supersedes the panel chrome, layout and interaction of #9 and #13 and **nothing about the mechanics** -- it carries the map from every existing mechanic to its new home, the four things the change costs, and seven decisions still open. The drill (glyph, cursor, planted rig, bar rig) is explicitly out of scope and moves across unchanged | DESIGN -- plan of record for presentation |
