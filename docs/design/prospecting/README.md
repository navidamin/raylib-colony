...
| 12 | [drill-tuning.md](drill-tuning.md) | **DRILL TUNING.** The clicking campaign, the screw-true spin law, and the 16x16 and 32x32 migration ledgers -- every constant the finer lattices touched, with the sim numbers that chose it | MEASURED |
