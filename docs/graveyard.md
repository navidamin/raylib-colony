...
Entries 1–8 were removed during the orbital-globe work (2026-09-02 to
2026-09-03) on `claude/lunar-elevation-lola-dem-1dcdtj`; the later ones
give their own dates. Each entry names
...
(Planet 100 km → Colony 25 km → Sect 5 km) were views, not a ladder; the
same day, the `lunarmap-wiring-site-selection` branch was merged, which
retired the Planet view and put the one ladder into the game (entry 11).
...
## 11. The 100 km playfield — the 20x20 grid, its anchor and the Planet view
...
B puts the ladder's district level there instead.
