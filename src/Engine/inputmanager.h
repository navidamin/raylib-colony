...
public:
    ...
    // (a release whose press did not travel -- a drag turns the globe or
    // moves a window rung, it does not claim), the button held (for that
    // drag), Esc or right-click as escape, right-click as
