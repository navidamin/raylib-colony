...
// 1:1 rather than stretched: 2048 at most, and no bigger than the probe's
// measured cost says can be built in 400 ms (a 38 ms probe: 1600; a
// 100 ms one: 1024). GetTerrainPathResolution() stays the size of the
